...
par(mfrow=c(2,2), oma=c(0,0,0,0), cex=0.75)

with(powercons,  {plot(Time,  Global_active_power, type="l", xlab= "", ylab="Global Active Power (kW)")

                 plot(Time,  Voltage, type="l", xlab= "datetime", ylab="Voltage (V)")
                 ...
                 plot(Time,  Global_reactive_power, type="l", xlab= "datetime", ylab="Global Reactive Power (kVAr)")
